...
![53dww](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323298.png)
...
![h5wu7](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323299.webp)
...
![t3y04](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323300.png)
...
![1f7al](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323301.png)
...
4. 查看查询缓存的状态变量：
   ...
   ![q5hne](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323302.png)
...
* 备份
  ...
  ![7he77](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323303.png)

* 恢复

  ![b2z78](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323304.png)
...
- SQL 分类
  ...
  - DCL（Data Control Language）数据控制语言
    ...
    ![2a40r](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323305.png)
...
* 例如：
  ...
  ![zqgdy](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323306.png)
...
* 例如
  ...
  ![s174c](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323307.png)
...
![vmhi5](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323308.png)
...
![m4cmg](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323309.png)
...
![k7n2w](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323310.png)
...
![j3itu](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323311.png)
...
* 数据准备
  ...
  ![qbqw7](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323312.png)
...
![7nsou](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323313.png)
...
* 操作方式：
  ...
  * 对 MERGE 表进行 DROP 操作，但是这个操作只是删除 MERGE 表的定义，对内部的表是没有任何影响的
  ...
  ![fpmu7](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323314.png)
...
![43hwu](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323315.png)
...
![3mu6u](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323316.png)
...
![r40j5](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323317.png)
...
![1o08u](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323318.jpg)
...
![o9ayu](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323319.png)
...
* 插入前 4 个字母 C N G A 
  ...
  ![l0bnq](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323320.png)

* 插入 H，n>4，中间元素 G 字母向上分裂到新的节点

  ![7vhco](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323321.png)

* 插入 E、K、Q 不需要分裂

  ![04l5v](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323322.png)

* 插入 M，中间元素 M 字母向上分裂到父节点 G

  ![wb4lg](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323323.png)

* 插入 F，W，L，T 不需要分裂

  ![6hu0o](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323324.png)

*  插入 Z，中间元素 T 向上分裂到父节点中

  ![h9zqw](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323325.png)

* 插入 D，中间元素 D 向上分裂到父节点中，然后插入 P，R，X，Y 不需要分裂

  ![m9e5f](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323326.png)

*  最后插入 S，NPQR 节点 n>5，中间节点 Q 向上分裂，但分裂后父节点 DGMT 的 n>5，中间节点 M 向上分裂

  ![ra6al](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323327.png)
...
![ncnis](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323328.png)
...
![hpvny](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323329.png)
...
![7zwjm](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323330.png)
...
* 不使用索引下推优化时存储引擎通过索引检索到数据，然后回表查询记录返回给 Server 层，**服务器判断数据是否符合条件**
  ...
  ![jqiyo](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323331.png)
* 使用索引下推优化时，如果**存在某些被索引的列的判断条件**时，由存储引擎在索引遍历的过程中判断数据是否符合传递的条件，将符合条件的数据进行回表，检索出来返回给服务器，由此减少 IO 次数

  ![8qf3g](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323332.png)
...
* 优化前：在非主键索引树上找到满足第一个条件的行，然后通过叶子节点记录的主键值再回到主键索引树上查找到对应的行数据，再对比 AND 后的条件是否符合，符合返回数据，需要 4 次回表
  ...
  ![0pxzu](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323333.png)

* 优化后：检查索引中存储的列信息是否符合索引条件，然后交由存储引擎用剩余的判断条件判断此行数据是否符合要求，**不满足条件的不去读取表中的数据**，满足下推条件的就根据主键值进行回表查询，2 次回表
  ![0vqbt](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323334.png)
...
* 查看 SQL 执行频率：
  ...
  ![y4xy4](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323335.png)
...
* 查询 SQL 语句影响的行数：
  ...
  ![g8why](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323336.png)
...
* SHOW PROCESSLIST：**实时查看**当前 MySQL 在进行的连接线程，包括线程的状态、是否锁表、SQL 的执行情况，同时对一些锁表操作进行优化
  ...
  ![hjcsd](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323337.png)
...
![yrjtc](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323338.png)
...
![80x1b](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323339.png)
...
* id 相同时，执行顺序由上至下。连接查询的执行计划，记录的 id 值都是相同的，出现在前面的表为驱动表，后面为被驱动表
  ...
  ![wszr4](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323340.png)
...
* id 不同时，id 值越大优先级越高，越先被执行
  ...
  ![m7smf](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323341.png)
...
* id 有相同也有不同时，id 相同的可以认为是一组，从上往下顺序执行；在所有的组中，id 的值越大的组，优先级越高，越先执行
  ...
  ![7f5f8](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323342.png)
...
* 通过 have_profiling 参数，能够看到当前 MySQL 是否支持 profile：
  ![pyojr](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323343.png)

* 默认 profiling 是关闭的，可以通过 set 语句在 Session 级别开启 profiling：

  ![vsg7c](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323344.png)
...
* 执行 SHOW PROFILES 指令， 来查看 SQL 语句执行的耗时:
  ...
  ![702pg](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323345.png)
...
* 查看到该 SQL 执行过程中每个线程的状态和消耗的时间：
  ...
  ![1rehs](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323346.png)

* 在获取到最消耗时间的线程状态后，MySQL 支持选择 all、cpu、block io 、context switch、page faults 等类型查看 MySQL 在使用什么资源上耗费了过高的时间。例如，选择查看 CPU 的耗费时间：

  ![bngow](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323347.png)
...
![nmsml](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323348.png)
...
* 全值匹配：对索引中所有列都指定具体值，这种情况索引生效，执行效率高
  ...
  ![t3sk3](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323349.png)
...
* **最左前缀法则**：联合索引遵守最左前缀法则
  ...
  ![fjvlk](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323350.png)
  ...
  ![l1gmg](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323351.png)
  ...
  ![ad80b](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323352.png)
...
* **范围查询**右边的列，不能使用索引：
  ...
  ![bdbxw](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323353.png)
...
* 在索引列上**函数或者运算（+ - 数值）操作**， 索引将失效：会破坏索引值的有序性
  ...
  ![8r55v](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323354.png)
...
* **字符串不加单引号**，造成索引失效：隐式类型转换，当字符串和数字比较时会**把字符串转化为数字**
  ...
  ![tnku4](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323355.png)
...
* **用 OR 分割条件，索引失效**，导致全表查询：
  ...
  ![dah1x](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323356.png)
  ...
  **AND 分割的条件不影响**：
  ...
  ![tv8hz](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323357.png)
...
* **以 % 开头的 LIKE 模糊查询**，索引失效：
  ...
  ![s5skc](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323358.png)
  ...
  ![vyvzm](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323359.png)
...
* 如果 MySQL 评估使用索引比全表更慢，则不使用索引，索引失效：
  ...
  ![1tjuu](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323360.png)
...
* IS  NULL、IS NOT NULL  **有时**索引失效：
  ...
  ![rl5wy](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323361.png)
...
![0tmu1](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323362.png)
...
* 范围查询右边的列，不能使用索引，比如语句： `WHERE a > 1 AND b = 1 `，在 a 大于 1 的时候，b 是无序的，a > 1 是扫描时有序的，但是找到以后进行寻找 b 时，索引树就不是有序的了
  ...
  ![3glda](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323363.png)

* 以 % 开头的 LIKE 模糊查询，索引失效，比如语句：`WHERE a LIKE '%d'`，前面的不确定，导致不符合最左匹配，直接去索引中搜索以 d 结尾的节点，所以没有顺序
                                  ![6qt78](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323364.png)
...
![bakvm](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323365.png)
...
![tx7sp](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323366.png)
...
![064px](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323367.png)
...
![u2i6r](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323368.png)
...
1. **主键顺序插入**：因为 InnoDB 类型的表是按照主键的顺序保存的，所以将导入的数据按照主键的顺序排列，可以有效的提高导入数据的效率，如果 InnoDB 表没有主键，那么系统会自动默认创建一个内部列作为主键
   ...
   * 插入 ID 顺序排列数据：
   ...
   ![eybcr](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323369.png)

   * 插入 ID 无序排列数据：

   ![nx1p9](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323370.png)

2. **关闭唯一性校验**：在导入数据前执行 `SET UNIQUE_CHECKS=0`，关闭唯一性校验；导入结束后执行 `SET UNIQUE_CHECKS=1`，恢复唯一性校验，可以提高导入的效率。

   ![9ajgf](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323371.png)
...
3. **手动提交事务**：如果应用使用自动提交的方式，建议在导入前执行`SET AUTOCOMMIT=0`，关闭自动提交；导入结束后再打开自动提交，可以提高导入的效率。
   ...
   ![w1k5d](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323372.png)
...
* 第一种是通过对返回数据进行排序，所有不通过索引直接返回结果的排序都叫 FileSort 排序，会在内存中重新排序
  ...
  ![tssz4](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323373.png)
...
* 第二种通过有序索引顺序扫描直接返回**有序数据**，这种情况为 Using index，不需要额外排序，操作效率高
  ...
  ![26vg8](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323374.png)
...
* 多字段排序：
  ...
  ![eqfe4](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323375.png)
...
* 分组查询：
  ...
  ![9718h](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323376.png)
...
* 查询包含 GROUP BY 但是用户想要避免排序结果的消耗， 则可以执行 ORDER BY NULL 禁止排序：
  ...
  ![6630d](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323377.png)
...
* 创建索引：索引本身有序，不需要临时表，也不需要再额外排序
  ...
  ![9hxcb](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323378.png)
...
* 执行查询语句：
  ...
  ![29m9v](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323379.png)
...
* 使用 UNION 替换 OR，求并集：
  ...
  ![c8yyl](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323380.png)
...
* 执行计划：
  ...
  ![2yhss](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323381.png)
...
* 优化后：
  ...
  ![se0a4](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323383.png)
...
* 分页查询：
  ...
  ![svhp0](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323384.png)
...
* 优化方式一：内连接查询，在索引列 id 上完成排序分页操作，最后根据主键关联回原表查询所需要的其他列内容
  ...
  ![7x5zj](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323385.png)
...
* 优化方式二：方案适用于主键自增的表，可以把 LIMIT 查询转换成某个位置的查询
  ...
  ![rr90m](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323386.png)
...
* USE INDEX：在查询语句中表名的后面添加 USE INDEX 来提供 MySQL 去参考的索引列表，可以让 MySQL 不再考虑其他可用的索引
  ...
  ![sfezy](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323387.png)
...
* IGNORE INDEX：让 MySQL 忽略一个或者多个索引，则可以使用 IGNORE INDEX 作为提示
  ...
  ![wckka](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323388.png)
...
* FORCE INDEX：强制 MySQL 使用一个特定的索引
  ...
  ![vqlc7](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323389.png)
...
* 计数直接放到数据库里单独的一张计数表中，利用事务解决计数精确问题：
  ...
  ![lktyi](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323390.png)
...
![b5l3f](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323391.png)
...
![alg41](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323392.png)
...
![0eqov](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323393.png)
...
![yv1rx](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323394.png)
...
![mkczj](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323395.png)
...
![z8fre](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323396.png)
...
![zo2bj](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323397.png)
...
![qdi08](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323398.png)
...
![mhivj](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323399.png)
...
![nh9i7](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323400.webp)
...
![2j5to](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323401.png)
...
* C1、C2 加读锁，同时查询可以正常查询出数据
  ...
  ![bxd4s](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323402.png)
...
* C1 加读锁，C1、C2 查询未锁定的表，C1 报错，C2 正常查询
  ...
  ![yfjtt](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323403.png)
  ...
  ![wb2b2](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323404.png)
...
* C1 加写锁，C1、C2查询表，C1 正常查询，C2 需要等待
  ...
  ![b9vr8](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323405.png)
...
* C1、C2 同时加写锁
  ...
  ![rjuh4](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323406.png)
...
* 查看锁竞争：
  ...
  ![nucj0](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323407.png)
  ...
  ![rej6x](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323408.png)
...
* 查看锁状态：
  ...
  ![ue8bi](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323409.png)
...
* 查询 id 为 3 的数据，正常查询：
  ...
  ![dx7b0](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323410.png)
...
* C1 更新 id 为 3 的数据，但不提交：
  ...
  ![uczjr](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323411.png)
  ...
  ![ljyvp](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323412.png)
  ...
  ![bih7v](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323413.png)
...
* C1 更新 id 为 3 的数据，但不提交，C2 也更新 id 为 3 的数据：
  ...
  ![baehd](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323414.png)
...
* 操作不同行的数据：
  ...
  ![2ktwp](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323415.png)
...
* 查询数据表：
  ...
  ![hdte9](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323416.png)
...
* C1 根据 id 范围更新数据，C2 插入数据：
  ...
  ![uwrby](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323417.png)
...
![2lo92](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323418.webp)
...
* 执行更新语句：
  ...
  ![kedho](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323419.png)
...
![a4lsp](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323420.png)
...
![q5o2b](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323421.png)
...
![sjyxw](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323422.jpg)
...
* 分流查询：通过 MySQL 的主从复制，实现读写分离，使增删改操作走主节点，查询操作走从节点，从而可以降低单台服务器的读写压力
  ...
  ![s5cif](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323423.jpg)
...
4. 查看 master 状态：
   ...
   ![x0xnr](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323424.png)
...
2. 在从库中查询数据，进行验证：
   ...
   ![6od36](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323425.png)

   在该数据库中，查询表中的数据：

   ![ke962](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323426.png)
...
* 查看日志内容：
  ...
  ![8qo7w](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323427.png)
...
* 查看日志内容：日志格式 ROW，直接查看数据是乱码，可以在 mysqlbinlog 后面加上参数 -vv 
  ...
  ![4npac](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323428.png)
...
![288o7](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323429.png)
...
* 直接通过 cat 指令查询该日志文件：
  ...
  ![x2swj](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323430.png)
...
* 如果慢查询日志内容很多，直接查看文件比较繁琐，可以借助 mysql 自带的 mysqldumpslow 工具对慢查询日志进行分类汇总：
  ...
  ![hqt7k](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323431.png)
...
![jmzof](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323432.png)
                    

第一范式表：

![ykbf4](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323433.png)
...
![24jof](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323434.png)
...
![0dhb7](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323435.png)

***
### 总结

![vdaxa](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/MySQL/202410141323436.png)
