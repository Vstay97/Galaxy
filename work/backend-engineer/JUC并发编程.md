...
![JUC-两阶段终止模式](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126076.png)
...
![JUC-线程6种状态](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126078.png)
...
* Mark Word 结构：最后两位是**锁标志位**
  ...
  ![JUC-Monitor-MarkWord结构32位](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126079.png)

* 64 位虚拟机 Mark Word：

  ![JUC-Monitor-MarkWord结构64位](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126080.png)
...
* 当 Thread-2 执行 synchronized(obj) 就会将 Monitor 的所有者 Owner 置为 Thread-2，Monitor 中只能有一个 Owner，**obj 对象的 Mark Word 指向 Monitor**，把**对象原有的 MarkWord 存入线程栈中的锁记录**中（轻量级锁部分详解）
  ![JUC-Monitor工作原理1](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126081.png)
* 在 Thread-2 上锁的过程，Thread-3、Thread-4、Thread-5 也执行 synchronized(obj)，就会进入 EntryList BLOCKED（双向链表）
* Thread-2 执行完同步代码块的内容，根据 obj 对象头中 Monitor 地址寻找，设置 Owner 为空，把线程栈的锁记录中的对象头的值设置回 MarkWord
* 唤醒 EntryList 中等待的线程来竞争锁，竞争是**非公平的**，如果这时有新的线程想要获取锁，可能直接就抢占到了，阻塞队列的线程就会继续阻塞
* WaitSet 中的 Thread-0，是以前获得过锁，但条件不满足进入 WAITING 状态的线程（wait-notify 机制）

![JUC-Monitor工作原理2](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126082.png)
...
![JUC-锁升级过程](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126083.png)
...
* 创建锁记录（Lock Record）对象，每个线程的**栈帧**都会包含一个锁记录的结构，存储锁定对象的 Mark Word
  ...
  ![JUC-轻量级锁原理1](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126085.png)

* 让锁记录中 Object reference 指向锁住的对象，并尝试用 CAS 替换 Object 的 Mark Word，将 Mark Word 的值存入锁记录
  
* 如果 CAS 替换成功，对象头中存储了锁记录地址和状态 00（轻量级锁） ，表示由该线程给对象加锁
  ![JUC-轻量级锁原理2](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126086.png)
...
* 如果 CAS 失败，有两种情况：
  ...
  * 如果是线程自己执行了 synchronized 锁重入，就添加一条 Lock Record 作为重入的计数
  ...
  ![JUC-轻量级锁原理3](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126087.png)
...
* 当 Thread-1 进行轻量级加锁时，Thread-0 已经对该对象加了轻量级锁
  ...
  ![JUC-重量级锁原理1](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126088.png)

* Thread-1 加轻量级锁失败，进入锁膨胀流程：为 Object 对象申请 Monitor 锁，**通过 Object 对象头获取到持锁线程**，将 Monitor 的 Owner 置为 Thread-0，将 Object 的对象头指向重量级锁地址，然后自己进入 Monitor 的 EntryList BLOCKED

  ![JUC-重量级锁原理2](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126089.png)
...
* 自旋成功的情况：
      ![JUC-自旋成功](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126090.png)

* 自旋失败的情况：

  ![JUC-自旋失败](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126091.png)
...
![JUC-park原理1](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126093.png)
...
* 先 unpark：
  ...
  ![JUC-park原理2](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126094.png)
...
![JUC-保护性暂停](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126095.png)
...
![JUC-保护性暂停多任务版](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126096.png)
...
![JUC-生产者消费者模式](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126097.png)
...
![JMM内存模型](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126098.png)
...
![JMM-内存交互](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126099.png)
...
![JMM-可见性例子](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126100.png)
...
![JMM-CPU缓存结构](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126101.png)
...
![JUC-内存伪共享](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126102.png)
...
![JUC-缓存一致性](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126103.png)
...
* 读屏障（lfence，Load Barrier）保证在该屏障之后的，对共享变量的读取，从主存刷新变量值，加载的是主存中最新数据
  ...
  ![JMM-volatile保证可见性](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126104.png)
...
* 有序性的保证也只是保证了本线程内相关代码不被重排序
  ...
  ![JMM-volatile不能保证原子性](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126105.png)
...
![JMM-DCL出现的问题](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126106.png)
...
![JUC-伪共享1](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126107.png)

@sun.misc.Contended：防止缓存行伪共享，在使用此注解的对象或字段的前后各增加 128 字节大小的 padding，使用 2 倍于大多数硬件缓存行让 CPU 将对象预读至缓存时**占用不同的缓存行**，这样就不会造成对方缓存行的失效

![JUC-伪共享2](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126108.png)
...
![JUC-ThreadLocal数据结构JDK8前](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126109.png)
...
![JUC-ThreadLocal数据结构JDK8后](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126110.png)
...
* set()：添加数据，ThreadLocalMap 使用**线性探测法来解决哈希冲突**
  ...
  * 在探测过程中 ThreadLocal 会复用 key 为 null 的脏 Entry 对象，并进行垃圾清理，防止出现内存泄漏
  ...
  ![JUC-replaceStaleEntry流程](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126111.png)
...
* 探测式清理：沿着开始位置向后探测清理过期数据，沿途中碰到未过期数据则将此数据 rehash 在 table 数组中的定位，重定位后的元素理论上更接近 `i = entry.key & (table.length - 1)`，让**数据的排列更紧凑**，会优化整个散列表查询性能
  ...
  ![JUC-ThreadLocal探测式清理1](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126112.png)

  ![JUC-ThreadLocal探测式清理2](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126113.png)
...
* 如果 key 使用强引用：使用完 ThreadLocal ，threadLocal Ref 被回收，但是 threadLocalMap 的 Entry 强引用了 threadLocal，造成 threadLocal 无法被回收，无法完全避免内存泄漏
  ...
  ![JUC-ThreadLocal内存泄漏强引用](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126114.png)
...
* 如果 key 使用弱引用：使用完 ThreadLocal ，threadLocal Ref 被回收，ThreadLocalMap 只持有 ThreadLocal 的弱引用，所以threadlocal 也可以被回收，此时 Entry 中的 key = null。但没有手动删除这个 Entry 或者 CurrentThread 依然运行，依然存在强引用链，value 不会被回收，而这块 value 永远不会被访问到，也会导致 value 内存泄漏
  ...
  ![JUC-ThreadLocal内存泄漏弱引用](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126115.png)
...
* 当一个节点入队：
  ...
  ![JUC-LinkedBlockingQueue入队流程](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126116.png)
...
* `h = head` → `first = h.next` 
  ...
  ![JUC-LinkedBlockingQueue出队流程1](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126117.png)

* `h.next = h` → `head = first`

  ![JUC-LinkedBlockingQueue出队流程2](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126118.png)
...
![JUC-线程池工作原理](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126119.png)
...
![JUC-newSingleThreadExecutor](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126120.png)
...
* 状态表示：
  ...
  ![JUC-线程池状态转换图](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126121.png)
...
* 请求的共享资源被占用，AQS 用队列实现线程阻塞等待以及被唤醒时锁分配的机制，将暂时获取不到锁的线程加入到队列中
  ...
  ![JUC-AQS原理图](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126122.png)
...
* 使用了 FIFO 先入先出队列，并不支持优先级队列，**同步队列是双向链表，便于出队入队**
  ...
  ![JUC-AQS队列设计](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126123.png)
...
![JUC-ReentrantLock-非公平锁1](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126124.png)
...
* 接下来进入 addWaiter 逻辑，构造 Node 队列（不是阻塞队列），前置条件是当前线程获取锁失败，说明有线程占用了锁
  ...
  * Node 的创建是懒惰的，其中第一个 Node 称为 **Dummy（哑元）或哨兵**，用来占位，并不关联线程
  ...
  ![JUC-ReentrantLock-非公平锁2](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126125.png)
...
* 再有多个线程经历竞争失败后：
  ...
  ![JUC-ReentrantLock-非公平锁3](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126126.png)
...
* 唤醒的线程会从 park 位置开始执行，如果加锁成功（没有竞争），会设置
  ...
  * 原本的 head 因为从链表断开，而可被垃圾回收（图中有错误，原来的头节点的 waitStatus 被改为 0 了）
  ...
  ![JUC-ReentrantLock-非公平锁4](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126127.png)
...
* 如果这时有其它线程来竞争**（非公平）**，例如这时有 Thread-4 来了并抢占了锁
  ...
  * Thread-1 再次进入 acquireQueued 流程，获取锁失败，重新进入 park 阻塞
  ...
  ![JUC-ReentrantLock-非公平锁5](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126128.png)
...
* 开始 Thread-0 持有锁，调用 await，线程进入 ConditionObject 等待，直到被唤醒或打断，调用 await 方法的线程都是持锁状态的，所以说逻辑里**不存在并发**
  ...
  ![JUC-ReentrantLock-条件变量1](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126129.png)
...
* fullyRelease 中会 unpark AQS 队列中的下一个节点竞争锁，假设 Thread-1 竞争成功
  ...
  ![JUC-ReentrantLock-条件变量2](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126130.png)
...
* 执行 transferForSignal，**先将节点的 waitStatus 改为 0，然后加入 AQS 阻塞队列尾部**，将 Thread-3 的 waitStatus 改为 -1
  ...
  ![JUC-ReentrantLock-条件变量3](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126131.png)
...
* 补充情况：查询线程 A 查询数据时恰好缓存数据由于时间到期失效，或是第一次查询
  ...
  ![JUC-ReentrantReadWriteLock缓存](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126132.png)
...
* 获取读锁失败，进入 sync.doAcquireShared(1) 流程开始阻塞，首先也是调用 addWaiter 添加节点，不同之处在于节点被设置为 Node.SHARED 模式而非 Node.EXCLUSIVE 模式，注意此时 t2 仍处于活跃状态
  ...
  ![JUC-ReentrantReadWriteLock加锁1](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126133.png)

* 这种状态下，假设又有 t3 r.lock，t4 w.lock，这期间 t1 仍然持有锁，就变成了下面的样子

  ![JUC-ReentrantReadWriteLock加锁2](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126134.png)
...
* 接下来 t2 调用 setHeadAndPropagate(node, 1)，它原本所在节点被置为头节点；还会检查下一个节点是否是 shared，如果是则调用 doReleaseShared() 将 head 的状态从 -1 改为 0 并唤醒下一个节点，这时 t3 在 doAcquireShared 内 parkAndCheckInterrupt() 处恢复运行，**唤醒连续的所有的共享节点**
  ...
  ![JUC-ReentrantReadWriteLock解锁1](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126135.png)
...
* t4 在 acquireQueued 中 parkAndCheckInterrupt 处恢复运行，再次 for (;;) 这次自己是头节点的临节点，并且没有其他节点竞争，tryAcquire(1) 成功，修改头结点，流程结束
  ...
  ![JUC-ReentrantReadWriteLock解锁2](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126136.png)
...
![JUC-CyclicBarrier工作原理](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126137.png)
...
* Semaphore 的 permits（state）为 3，这时 5 个线程来获取资源
  ...
  ![JUC-Semaphore工作流程1](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126138.png)
...
* 这时 Thread-4 释放了 permits，状态如下
  ...
  ![JUC-Semaphore工作流程2](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126139.png)
...
![ConcurrentHashMap数据结构](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126140.png)
...
* transfer()：数据转移到新表中，完成扩容
  ...
  ![JUC-ConcurrentHashMap-LastRun机制](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126141.png)
...
* 缺点：Segments 数组默认大小为16，这个容量初始化指定后就不能改变了，并且不是懒惰初始化
  ...
  ![](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126142.png)
...
![JUC-CopyOnWriteArrayList弱一致性](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126143.png)
...
![JUC-ConcurrentSkipListMap数据结构](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126145.png)
...
* findPredecessor()：寻找前置节点
  ...
  ![JUC-ConcurrentSkipListMap-Put流程](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126146.png)
...
* remove()
  ...
  ![JUC-ConcurrentSkipListMap-remove流程](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126147.png)
...
![JUC-ConcurrentLinkedQueue入队操作1](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126148.png)

![JUC-ConcurrentLinkedQueue入队操作2](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126149.png)

![JUC-ConcurrentLinkedQueue入队操作3](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126150.png)
...
![JUC-ConcurrentLinkedQueue出队操作1](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126151.png)

![JUC-ConcurrentLinkedQueue出队操作2](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126152.png)

![JUC-ConcurrentLinkedQueue出队操作3](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126153.png)
...
![IO模型-阻塞式IO](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126154.png)
...
![IO模型-非阻塞式IO](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126155.png)
...
![IO模型-信号驱动IO](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126156.png)
...
![IO模型-IO复用模型](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126157.png)
...
![IO模型-异步IO模型](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126158.png)
...
![IO-select调用过程](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126159.png)
...
![IO-用户态和内核态](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126160.png)
...
![IO-系统调用的过程](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126161.jpeg)
...
![IO-DMA](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126162.png)
...
![IO-BIO工作流程](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126163.png)

read 调用图示：read、write 都是系统调用指令

![IO-缓冲区读写](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126164.png)
...
![IO-mmap工作流程](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126165.png)
...
![IO-sendfile工作流程](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126166.png)
...
![三次握手](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126167.png)

![四次挥手](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126168.png)
...
* 常用 API：`public Socket accept()`，**阻塞等待**接收一个客户端的 Socket 管道连接请求，连接成功返回一个 Socket 对象
  ...
  ![Netty-TCP三次握手](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126169.png)
...
![BIO工作机制](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126170.png)

![TCP-工作模型](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126171.png)
...
![NIO框架](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126172.png)
...
![NIO-Buffer](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126173.png)
...
![JVM-直接内存直接缓冲区](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126175.png)

![JVM-直接内存非直接缓冲区](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126176.png)
...
![NIO-复制文件](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126177.png)
...
![NIO-Selector](https://cdn.jsdelivr.net/gh/Vstay97/Img_storage@main/blog/2024/JUC%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B/202410121126178.png)
